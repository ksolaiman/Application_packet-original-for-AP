...
% % institution name
\newcommand{\InstitutionName}{Old Dominion University}
\newcommand{\shortInstitutionName}{ODU}
...
\newcommand{\SchoolName}{Old Dominion University}%{College of Engineering}
