...
% % institution name
\newcommand{\InstitutionName}{Western Michigan University}
\newcommand{\shortInstitutionName}{WMU}
\newcommand{\insEmpty}{}
...
\newcommand{\SchoolName}{College Of Engineering and Applied Science}
