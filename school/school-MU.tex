...
% % institution name
\newcommand{\InstitutionName}{University of Missouri}
\newcommand{\shortInstitutionName}{MU}

\newcommand{\diversityOrgInUni}{}%{SafeZONE, Association for Women in Science (AWIS), etc}

\newcommand{\InstituteSeal}{seals/University-of-Missouri.png}%{seals/marist-college.jpeg}%{seals/Horizontal_VT_Full_Color_CMYK.pdf}
