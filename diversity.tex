...
\begin{enumerate*}[leftmargin=*, noitemsep, topsep=0pt, label=(\arabic*)]
    ...
    \item Actively participating in workshops and organizations	that	promote diversity	in	\shortInstitutionName.% ~such as \diversityOrgInUni.
    % + \item Continuing	to	foster	relationships	between	\InstitutionName~ and	local minority-serving	institutions.
\end{enumerate*}
